...
# 214 "/data/data/com.termux/files/usr/bin/../../usr/include/android/api-level.h" 3 4
...
char* _Nonnull ctermid(char* _Nullable __buf) __attribute__((__availability__(android,strict,introduced=26 )));
...
# 369 "/data/data/com.termux/files/usr/bin/../../usr/include/stdio.h" 3 4
